...
| rawcount(threshold)  | -                                                                                    | Count of all pixels with a coverate fraction greater than the threshold | - | - |
| rawhitcount(threshold)  | -                                                                                    | Count of all pixels with a coverate fraction greater than the threshold, and a value set  | - | - |
