...
namespace exactextract {
    ...
    public:
        enum class AreaMethod { NONE, CARTESIAN, SPHERICAL };

        struct Options {
            // bool coverage_areas = false;   // whether to output coverage_area
            // instead of converage_fraction
            bool include_xy = false;  // whether to include columns for cell
                                      // center coordinates
            bool include_cell =
                false;  // whether to include a (0-based) cell index
            bool include_values =
                false;  // whether to include values of the value raster
            bool include_weights =
                false;  // whether to include values of the weighting raster
            AreaMethod area_method =
                AreaMethod::NONE;  // optional method by which to calculate a
                                   // cell area column
        };
        ...
        /// Method with which a CoverateProcessor can save a value to be applied
